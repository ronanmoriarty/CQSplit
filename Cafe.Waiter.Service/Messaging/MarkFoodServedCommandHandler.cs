...
{
    public class MarkFoodServedCommandHandler : IConsumer<IMarkFoodServed>
    {
        private readonly ILog _logger = LogManager.GetLogger(typeof(MarkFoodServedCommandHandler));
