...
namespace Cafe.DAL.Sql
{
    public class EventStoreUnitOfWork : IUnitOfWork
    {
        ...
        private void LogDbContextHashCodeForMultithreadingDiagnosticPurposes()
        {
            ...
            //2018 - 07 - 11 15:12:19,384[6] ERROR CQ.DAL.Sql.EventStoreUnitOfWork[(null)] - System.InvalidOperationException: An attempt was made to use the context while it is being configured.A DbContext instance cannot be used inside OnConfiguring since it is still being configured at this point.This can happen if a second operation is started on this context before a previous operation completed. Any instance members are not guaranteed to be thread safe.
            // at Microsoft.EntityFrameworkCore.DbContext.get_InternalServiceProvider()
            // at Microsoft.EntityFrameworkCore.DbContext.get_DbContextDependencies()
            // at Microsoft.EntityFrameworkCore.DbContext.EntryWithoutDetectChanges[TEntity](TEntity entity)
            // at Microsoft.EntityFrameworkCore.DbContext.SetEntityState[TEntity](TEntity entity, EntityState entityState)
            // at CQ.DAL.Sql.EventRepository.Add(IEvent event)
            // at CQ.DAL.CompositeEventStore.Add(IEvent event)
            // at CQ.DAL.EventHandler.<>c__DisplayClass3_0.<Handle>b__0()
            // at CQ.DAL.Sql.EventStoreUnitOfWork.ExecuteInTransaction(Action action)
