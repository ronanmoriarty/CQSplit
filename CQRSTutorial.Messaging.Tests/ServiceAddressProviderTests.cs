...
namespace CQRSTutorial.Messaging.Tests
{
    ...
    public class ServiceAddressProviderTests
    {
        ...
        {
            var endPointAddress = _serviceAddressProvider.GetServiceAddressFor<TestClass>();
        ...
        {
            var endPointAddress = _serviceAddressProvider.GetServiceAddressFor<ITestClass>();
            Assert.That(endPointAddress, Is.EqualTo("test_class"));
        }
        ...
        {
            var endPointAddress = _serviceAddressProvider.GetServiceAddressFor<IabcDef>();
