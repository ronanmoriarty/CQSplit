...
namespace Cafe.Waiter.Publisher.Console
{
    class Program
    {
        ...
        {
            var sessionFactory = new NHibernateConfiguration(new ConnectionStringProviderFactory("CQRSTutorial.Cafe.Waiter", "CQRSTUTORIAL_CAFE_WAITER_WRITEMODEL_CONNECTIONSTRING_OVERRIDE")).CreateSessionFactory();
