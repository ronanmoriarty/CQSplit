...
namespace Cafe.Waiter.Publisher.Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var eventToPublishRepository = new EventRepository(readSessionFactory, IsolationLevel.ReadCommitted, null, new EventToPublishMapper()); // TODO: we might be able to get rid IPublishConfiguration. Need to do a little more reading around fanout exchanges / topics etc with respect to MassTransit. We're not adding EventsToPublish here anyway, so null is fine in this case.
